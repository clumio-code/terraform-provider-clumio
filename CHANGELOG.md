...
* New field `earliest_last_modified_version` for protection group is introduced.
* Documentation for `bucket_rules` for protection group became more detailed.
* Upgraded Go dependencies to address Dependabot security alerts.
* Update supported Go versions to `1.23` and `1.24` to ensure compatibility with the two most recent major release of Go.
