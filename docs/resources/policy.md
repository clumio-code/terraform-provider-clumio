...
- `type` (String) The type of operation to be performed. Depending on the type selected, `advanced_settings` may also be required. See the [API Documentation for List policies](https://api.commvault.com/docs/SP42/api/cv/ClumioAPIs/list-policy-definitions/) for more information about the supported types.
